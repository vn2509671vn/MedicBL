...
require('../config.php');
    ...
    if(isset($_SESSION['lang'])){
         if($_SESSION['lang'] == 'en'){
            ...
            from posts where cat_id = '2' and posts.post_status = '1' 
    ...
    {  
        ...
        {  
           $output .= '  
                ...
                <div class="col-md-4"><a href="post_chitiet.php?cat_id=2&id='.$row['post_id'].'" class=""><img src="../admin/upload/tintuc/'.$row['post_image'].'" class="img-responsive"></a></div>
                <div class="col-md-8">
                    <h3 class="title uppercase"><a href="post_chitiet.php?cat_id=2&id='.$row['post_id'].'">'.$row['title'].'</a></h3>
                        <p class="text-muted"><span class="glyphicon glyphicon-calendar"></span> '.$row['post_date'].'</p>
                            '.$row['content'].'
                        <p class="text-muted"><a href="post_chitiet.php?cat_id=2&id='.$row['post_id'].'">Chi tiết</a></p>
                </div>
                </div>
                <hr class="divider">
            ';
    ...
    $query_page = "SELECT COUNT(*) AS count FROM posts where cat_id = '2' and posts.post_status = '1'";
