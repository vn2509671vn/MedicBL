...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
        	...
        	{
        	    var id = $(this).attr("id");
        	    var temp_app = 'camnghi_approve_temp' + id;
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                if ($_SESSION['ses_name'] == 'admin') {
                    ...
                    <li>
                        <a class="active-menu" href="../comments/index.php"><i class="fa fa-square-o "></i>Feeling Customer</a>
                    </li>
                    <!--  END MENU   ==========================================================================   -->
                    <?php
                }
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <div class="container">
                        <h1 class="page-head-line">Feeling Customer</h1>
                        <hr/>

                        <div class="content-loader">
                            <table cellspacing="0" width="100%" id="comment"
                                ...
                                $stmt = $db_con->prepare("SELECT * FROM camnghi_kh b ORDER BY camnghi_approved ASC, camnghi_id");
                                $stmt->execute();
                                $count =1;
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['camnghi_author']; ?></td>
                                        <td><?php echo $row['camnghi_image']; ?></td>
                                        <td><?php echo $row['camnghi_content']; ?></td>
                                        <td><?php echo $row['camnghi_date']; ?></td>
                                        <!--  START
                                            APPROVE BOOKING
                                        -->
                                        <td align="center">
                                            <a id="<?php echo $row['camnghi_id']; ?>" class="accept-link" 
                                               title="Click to Approve">
                                                <img class='img_accept<?php echo $row['camnghi_id']; ?>' <?php if($row['camnghi_approved']==0){ ?> src="../../assets/img/reject.png" <?php } else { ?> src="../../assets/img/accept.png" <?php }?>  width="40px"/>
                                            </a>
                                            <input id="camnghi_approve_temp<?php echo $row['camnghi_id']; ?>" type="text" value="<?php echo $row['camnghi_approved']; ?>" name="camnghi_approve_temp"  style='display:none;'  readonly="readonly" />
                                    
                                        </td>
                                        <!--  END
                                            APPROVE BOOKING
                                        -->
                                        <td align="center"><a id="<?php echo $row['camnghi_id']; ?>" class="delete-link"
                                                              href="#" title="Delete">
