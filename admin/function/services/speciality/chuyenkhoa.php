    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="header-right">
                ...
                <a href="../contact/contact.php" class="btn btn-info" title="New Message"><b>30 </b><i class="fa fa-envelope-o fa-2x"></i></a>
                <a href="../booking/book.php" class="btn btn-primary" title="New Booking"><b>40 </b><i class="fa fa-bars fa-2x"></i></a>
                    ...
                    <li>
                        <a class="active-menu-top" href="#"><i class="fa fa-bicycle "></i>Services <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a class="active-menu" href="chuyenkhoa.php"><i class="fa fa-code "></i>ChuyenKhoa List</a>
                            </li>
