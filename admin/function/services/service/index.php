                ...
                if ($_SESSION['ses_name'] == 'admin') {
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                                <a class="active-menu" href="index.php"><i class="fa fa-desktop "></i>Hospital Services </a>
                            </li>
                            <li>
                ...
                <div class="col-md-12">
                    <div class="container">
                        ...
                        <button class="btn btn-info" type="button" id="btn-add"><span
                                class="glyphicon glyphicon-pencil"></span> &nbsp; Add Service
                        </button>
                        <button class="btn btn-info" type="button" id="btn-view"><span
                                class="glyphicon glyphicon-eye-open"></span> &nbsp; View Service
                        </button>
                        <hr/>

                        <div class="content-loader">
                            <table cellspacing="0" width="100%" id="service"
                                   class="table table-striped table-hover table-responsive">
                                <thead>
                                <tr>
                                    <th>Service ID</th>
                                    <th>Service Name VN</th>
                                ...
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    $services_descript = substr($services_descript,0,80) . '...';
                                    $services_descript_en = $row['services_descript_en'];
                                    //$services_descript_en = substr($services_descript_en,0,strpos($services_descript_en,'.')) . '...';
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><a id="<?php echo $row['services_id']; ?>" class="delete-link"
                                                              href="#" title="Delete">
