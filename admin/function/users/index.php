        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                if ($_SESSION['ses_name'] == 'admin') {
                    ...
                    <!--  BEGIN USER   ==========================================================================   -->
                    <li>
                        <a class="active-menu" href="../users/index.php"><i class="fa fa-bug "></i>Users</a>
                    </li>
                ...
                <div class="col-md-12">
                    <div class="container">
                        ...
                        <button class="btn btn-info" type="button" id="btn-add"><span
                                class="glyphicon glyphicon-pencil"></span> &nbsp; Add User
                        </button>
                        <button class="btn btn-info" type="button" id="btn-view"><span
                                class="glyphicon glyphicon-eye-open"></span> &nbsp; View Users
                        </button>
                        <hr/>
                            ...
                            <table cellspacing="0" width="100%" id="user"
                                ...
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row['user_last_datetime']; ?></td>
                                        <td align="center">
                                            <a id="<?php echo $row['user_id']; ?>" class="edit-link" href="#"
                                               title="Edit">
                                                <img src="../../assets/img/edit.png" width="20px"/>
                                            </a></td>
                                        <td align="center"><a id="<?php echo $row['user_id']; ?>" class="delete-link"
                                                              href="#" title="Delete">
