        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                if ($_SESSION['ses_name'] == 'admin') {
                    ...
                    <li>
                        <a class="active-menu"  href="../menu/index.php"><i class="fa fa-sign-in "></i>Menu</a>
                    </li>
                    <!--  END MENU   ==========================================================================   -->
                    <!--  BEGIN MENU   ==========================================================================   -->
                ...
                <div class="col-md-12">
                    <div class="container">
                        ...
                        <div class="content-loader">
                            <table cellspacing="0" width="100%" id="menu"
                                ...
                                $stmt = $db_con->prepare("SELECT * FROM menu ORDER BY menu_id");
                                $stmt->execute();
                                $count =1;
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    $menu_descript_vn = $row['menu_descript_vn'];
                                    $menu_descript_vn = substr($menu_descript_vn,0,80) . '...';
                                    $menu_descript_en = $row['menu_descript_en'];
                                    $menu_descript_en = substr($menu_descript_en,0,80) . '...';
                                    ?>
                                    <tr>
                                        <td><?php echo $count; ?></td>
                                        <td><?php echo $row['menu_name_vn']; ?></td>
                                        <td><?php echo $menu_descript_vn; ?></td>
                                        <td><?php echo $row['menu_name_en']; ?></td>
                                        <td><?php echo $menu_descript_en; ?></td>
                                        <td><?php echo $row['menu_link']; ?></td>
                                        <td><?php echo $row['menu_parent']; ?></td>
                                        <td><?php echo $row['menu_pos']; ?></td>
                                        <td align="center">
                                            <a id="<?php echo $row['menu_id']; ?>" class="edit-link" href="#"
                                               title="Edit">
                                                <img src="../../assets/img/edit.png" width="20px"/>
                                            </a></td>
                                        <td align="center"><a id="<?php echo $row['menu_id']; ?>" class="delete-link"
                                                              href="#" title="Delete">
