    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            ...
            <div class="header-right">
                ...
                <a href="../booking/message-task.php" class="btn btn-info" title="New Message"><b>30 </b><i class="fa fa-envelope-o fa-2x"></i></a>
                <a href="../booking/message-task.php" class="btn btn-primary" title="New Booking"><b>40 </b><i class="fa fa-bars fa-2x"></i></a>
                <a href="../booking/logout.php" onclick="return check()" class="btn btn-danger" title="Logout"><i class="fa fa-exclamation-circle fa-2x"></i></a>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    ?>
                            ...
                            <a href="#"><i class="fa fa-yelp "></i>Departments Doctors <span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="../general/specialiy.php"><i class="fa fa-key "></i>Specialities</a>
                                    </li>     
                                </ul>
                            </li>
                    ...
                    <!--  BEGIN CONTACTS   ==========================================================================   -->
                    <li>
                        <a class="active-menu" href="contact.php"><i class="fa fa-flash "></i>Contacts</a>
