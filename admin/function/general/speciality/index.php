                ...
                if ($_SESSION['ses_name'] == 'admin') {
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                                <a class="active-menu" href="index.php"><i class="fa fa-key "></i>Specialities</a>
                            </li>
                        </ul>
                    </li>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <div class="container">
                        <h1 class="page-head-line">Specialities</h1>
                        <button class="btn btn-info" type="button" id="btn-add"><span
                                class="glyphicon glyphicon-pencil"></span> &nbsp; Add Speciality
                        </button>
                        <button class="btn btn-info" type="button" id="btn-view"><span
                                class="glyphicon glyphicon-eye-open"></span> &nbsp; View Speciality
                        </button>
                        <hr/>

                        <div class="content-loader">
                            <table cellspacing="0" width="100%" id="speciality"
                                   class="table table-striped table-hover table-responsive">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Speciality Name VN</th>
                                    <th>Speciality Nam EN</th>
                                    <th>Speciality Description VN</th>
                                    <th>Speciality Description EN</th>
                                    <th>edit</th>
                                    <th>delete</th>
                                </tr>
                                </thead>
                                ...
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    $speciality_descript = $row['speciality_descript'];
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $speciality_descript_en; ?></td>
                                        <td align="center">
                                            <a id="<?php echo $row['speciality_id']; ?>" class="edit-link" href="#"
                                               title="Edit">
                                                <img src="../../../assets/img/edit.png" width="20px"/>
                                            </a></td>
                                        <td align="center"><a id="<?php echo $row['speciality_id']; ?>" class="delete-link"
                                                              href="#" title="Delete">
