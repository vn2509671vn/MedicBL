                ...
                if ($_SESSION['ses_name'] == 'admin') {
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse in">
                            <li>
                                <a class="active-menu" href="index.php"><i class="fa fa-toggle-on"></i>Department Type</a>
                            </li>
                            <li>
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <div class="container">
                        <h1 class="page-head-line">Department Type</h1>
                        <button class="btn btn-info" type="button" id="btn-add"><span
                                class="glyphicon glyphicon-pencil"></span> &nbsp; Add Department Type
                        </button>
                        <button class="btn btn-info" type="button" id="btn-view"><span
                                class="glyphicon glyphicon-eye-open"></span> &nbsp; View Department Type
                        </button>
                        <hr/>
                        ...
                        <div class="content-loader">
                            <table cellspacing="0" width="100%" id="user"
                                ...
                                require_once '../../../../connect/dbconfig.php';
                                    ...
                                    $stmt = $db_con->prepare("SELECT * FROM department_type ORDER BY department_type_id DESC");
                                $stmt->execute();
                                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                    $department_type_name_vn = $row['department_type_name_vn'];
                                    $department_type_name_en = $row['department_type_name_en'];
                                    $department_type_descript_vn = $row['department_type_descript_en'];
                                    $department_type_descript_vn = substr($department_type_descript_vn,0,80) . '...';
                                    $department_type_descript_en = $row['department_type_descript_en'];
                                    $department_type_descript_en = substr($department_type_descript_en,0,80) . '...';
                                    ?>
                                    <tr>
                                        <td><?php echo $row['department_type_id']; ?></td>
                                        <td><?php echo $department_type_name_vn; ?></td>
                                        <td><?php echo $department_type_descript_vn; ?></td>
                                        <td><?php echo $department_type_name_en; ?></td>
                                        <td><?php echo $department_type_descript_en; ?></td>
                                        <td align="center">
                                            <a id="<?php echo $row['department_type_id']; ?>" class="edit-link" href="#"
                                               title="Edit">
                                                <img src="../../../assets/img/edit.png" width="20px"/>
                                            </a></td>
                                        <td align="center"><a id="<?php echo $row['department_type_id']; ?>" class="delete-link"
                                                              href="#" title="Delete">
