        ...
        <div class="col-md-8">
            <div class="col-md-12">
                <div class="row text-left">
                  <div class="col-sm-12">
                    <a class="text-left a-title line-hight-nor"><?php echo $main['bantinsuckhoe'];?></a>
                  </div>
                </div>
                <br>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="panel panel-default text-left">
                  ...
                  <a href="bantinsuckhoe.php" class="list-group-item active-item"><span class="glyphicon glyphicon-menu-right"></span> <?php echo $main['bantinsuckhoe'];?></a>
                </div>
              </div>
            </div>
            <br>
...
function pagination(page){
    $.ajax ({
        type: "POST",
        url: "../models/ajax_bantinsuckhoe.php",
        data: "page="+page,
