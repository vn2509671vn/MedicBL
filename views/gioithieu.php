...
<!-- Add start model-->
<?php
$hosInfo = mysql_fetch_array(getgioithieuchung($_SESSION['lang']));
?>
<!-- Add end model-->
      ...
      <div class="col-md-12">
        <div class="row text-left">
          <div class="col-md-12 padding-left-0">
            <a class="text-left a-title"><?php echo $main['gioithieuchung'];?></a>
          </div>
        </div>
        <br>
        <div class="row text-left">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default text-left">
              <a href="gioithieu.php" class="list-group-item active-item"><span class="glyphicon glyphicon-menu-right"></span> <?php echo $main['gioithieuchung'];?></a>
