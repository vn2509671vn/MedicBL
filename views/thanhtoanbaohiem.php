...
<!-- Add start model-->
<?php
$hosInfo = mysql_fetch_array(getthanhtoanbaohiem($_SESSION['lang']));
?>
<!-- Add end model-->
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="panel panel-default text-left">
              <a href="thanhtoanbaohiem.php" class="list-group-item active-item"><span class="glyphicon glyphicon-menu-right"></span> <?php echo $main['thanhtoanbaohiem']; ?></a>
